...
import { useTranslation } from '../modern/ModernComponents';
...
const ModernFooter = () => {
  ...
  const footerLinks = {
    ...
    legal: [
      ...
      { name: 'سياسة الملفات', href: '/file-policy' },
    ],
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 via-purple-500 to-blue-500 flex items-center justify-center shadow-modern">
                <svg 
                  viewBox="0 0 24 24" 
              ...
              <div>
                <div className="text-xl font-bold gradient-text">Fyleo</div>
