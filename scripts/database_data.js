// سكريبت بسيط لإضافة البيانات المبدئية
// نسخ هذا الكود وتشغيله في console المتصفح على صفحة الموقع

const DATABASE_ID = '68d97982002b686c7151';

// البيانات المبدئية
const categories = [
    { id: 'comp-sci', name: 'علوم الكمبيوتر', icon: '💻', color: '#3B82F6', description: 'برمجة، خوارزميات، هياكل البيانات، أمن المعلومات' },
    { id: 'engineering', name: 'الهندسة', icon: '⚙️', color: '#F59E0B', description: 'هندسة مدنية، كهربائية، ميكانيكية، كيميائية' },
    { id: 'medicine', name: 'الطب', icon: '🏥', color: '#DC2626', description: 'طب عام، تخصصات طبية، تمريض، صيدلة' },
    { id: 'business', name: 'إدارة الأعمال', icon: '💼', color: '#059669', description: 'إدارة، تسويق، محاسبة، اقتصاد' },
    { id: 'science', name: 'العلوم الطبيعية', icon: '🔬', color: '#7C3AED', description: 'فيزياء، كيمياء، أحياء، رياضيات' },
    { id: 'arts', name: 'الآداب والفنون', icon: '🎨', color: '#EC4899', description: 'لغة عربية، إنجليزية، تاريخ، فلسفة، فنون' },
    { id: 'law', name: 'القانون', icon: '⚖️', color: '#374151', description: 'قانون مدني، جنائي، تجاري، دولي' },
    { id: 'education', name: 'التربية والتعليم', icon: '📚', color: '#0891B2', description: 'أصول التربية، مناهج، علم النفس التربوي' },
    { id: 'social', name: 'العلوم الاجتماعية', icon: '👥', color: '#EA580C', description: 'علم الاجتماع، علم النفس، الخدمة الاجتماعية' },
    { id: 'islamic', name: 'الدراسات الإسلامية', icon: '☪️', color: '#16A34A', description: 'القرآن الكريم، الحديث الشريف، الفقه، التفسير' }
];
...
const fileTypes = [
    { id: 'pdf', name: 'PDF', extension: 'pdf', icon: '📄', color: '#DC2626' },
    { id: 'doc', name: 'Word Document', extension: 'docx', icon: '📝', color: '#2563EB' },
    { id: 'ppt', name: 'PowerPoint', extension: 'pptx', icon: '📊', color: '#DC2626' },
    { id: 'excel', name: 'Excel', extension: 'xlsx', icon: '📈', color: '#059669' },
    { id: 'image', name: 'صورة', extension: 'jpg,png,gif', icon: '🖼️', color: '#7C3AED' },
    { id: 'video', name: 'فيديو', extension: 'mp4,avi,mov', icon: '🎥', color: '#EA580C' },
    { id: 'audio', name: 'صوت', extension: 'mp3,wav,m4a', icon: '🎵', color: '#EC4899' },
    { id: 'archive', name: 'أرشيف', extension: 'zip,rar,7z', icon: '📦', color: '#374151' }
];

console.log('إذا كنت تريد إضافة البيانات، استخدم السكريبت التالي:');
console.log('\n// التصنيفات:');
